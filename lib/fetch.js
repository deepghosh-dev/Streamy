...
export const getSongsByQuery = async (e) => {
    try {
        return await fetch(`${api_url}search/songs?query=` + encodeURIComponent(String(e)));
    }
    catch (e) {
        console.log(e);
    }
...
export const getSongsByQueryWithOptions = async (query, options) => {
    try {
        return await fetch(`${api_url}search/songs?query=` + encodeURIComponent(String(query)), options);
    }
    catch (e) {
        console.log(e);
    }
